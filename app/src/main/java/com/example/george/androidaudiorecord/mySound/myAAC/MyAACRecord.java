...
import com.example.george.androidaudiorecord.mySound.myMp3.DataEncodeThread;
import com.example.george.androidaudiorecord.mySound.myMp3.PCMFormat;
 ...
 * Describe:
 */
public class MyAACRecord {
    private static final String TAG = "MyAACRecord";
    ...
    private MyPCM2AACEncodeThread mEncodeThread;
     ...
     */
    public MyAACRecord(File recordFile) {
    ...
    private void initAudioRecorder() throws IOException {
        ...
        Log.d(TAG, "pcm2aac Init");
//        LameUtil.init(DEFAULT_SAMPLING_RATE, DEFAULT_LAME_IN_CHANNEL, DEFAULT_SAMPLING_RATE, DEFAULT_LAME_MP3_BIT_RATE, DEFAULT_LAME_MP3_QUALITY);
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.JELLY_BEAN) {
            MyAACUtils.getInstance().prepare(DEFAULT_SAMPLING_RATE,1,AudioFormat.ENCODING_PCM_16BIT,mBufferSize);
        }
        // Create and run thread used to encode data
        // The thread will
        mEncodeThread = new MyPCM2AACEncodeThread(mRecordFile, mBufferSize);
        mEncodeThread.start();

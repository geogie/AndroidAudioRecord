...
public class RecordHelper {
     ...
     * 录音机参数
     */
    private static final int CONFIG_CHANNEL = AudioFormat.CHANNEL_IN_DEFAULT;//1
    private static final int CONFIG_ENCODING = AudioFormat.ENCODING_PCM_16BIT;//2
    ...
    private class AudioRecordThread extends Thread {
        ...
        AudioRecordThread() {
            bufferSize = AudioRecord.getMinBufferSize(CONFIG_FREQUENCY, CONFIG_CHANNEL, CONFIG_ENCODING) * RECORD_AUDIO_BUFFER_TIMES;
            Logger.d(TAG, "record buffer size = %s", bufferSize);
            audioRecord = new AudioRecord(MediaRecorder.AudioSource.MIC, CONFIG_FREQUENCY, CONFIG_CHANNEL, CONFIG_ENCODING, bufferSize);
        }
        ...
        public void run() {
            ...
            try {
                ...
                while (state == RecordState.RECORDING) {
                    Logger.i(TAG,"byteBuffer:"+byteBuffer);
